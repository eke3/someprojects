...
class Railroad{
    ...
    // ***************************************************
    void extendAtTail2(Station* aNewStation);  // extends at tail using a Station*
    Station* findStation(int aCode);  // returns a Station* from the list with specified code
    bool stationExists(int aCode);  // returns whether a station with specified code exists
};
