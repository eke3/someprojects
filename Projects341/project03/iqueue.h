...
class IQueue{
    ...
    void clear(Node* aParent);
    void printCropsQueue(Node* aParent) const;
    Node* copyQueue(Node* aParent);
    Node* mergeMax(Node* aHeap, Node* aHeap2) const;
    Node* mergeMin(Node* aHeap, Node* aHeap2) const;
};
#endif
