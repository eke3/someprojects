...
class Streak{
    ...
    Tiger* getTiger(int aId, Tiger* aParent) const;// gets tiger with a specific ID
    void inOrder(Tiger* aParent) const;// helper for recursive traversal
    void clear(Tiger* aTiger);// helper for recursive traversal
    Tiger* remove(Tiger& aTiger, Tiger* tiger);// helper for recursive traversal
    Tiger* getMin(Tiger* aTiger);// gets Tiger with lowest ID
    void TreetoArray(int dead[], Tiger* aParent);//helper for removeDead
    int countTigerCubs(Tiger* aParent) const;// helper for recursive traversal
    Tiger* rightRotation(Tiger* aParent);// performs right rotation
    Tiger* leftRotation(Tiger* aParent);// performs left rotation
    Tiger* insert(Tiger aTiger, Tiger* aParent);// helper for recursive traversal
    bool testProperty(Tiger* aParent);// helper for testing
    bool verifyBalance(Tiger* aParent);// helper for testing
    int countTigers(Tiger* aParent);// helper
    void shiftArray(int array[], int size);// helper for removeDead
    bool fullCheckBalance(Tiger* aParent);// helper for testing
};
#endif